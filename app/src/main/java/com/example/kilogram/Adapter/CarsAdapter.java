package com.example.kilogram.Adapter;
...
import com.example.kilogram.View.DetailCars;
    ...
    public void onBindViewHolder(@NonNull CarsAdapter.ViewHolder viewHolder, final int i) {
        ...
        viewHolder.itemView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent x = new Intent(context, DetailCars.class);
                x.putExtra("name", carsModels.get(i).getCars_name());
                x.putExtra("image", carsModels.get(i).getCars_img());
